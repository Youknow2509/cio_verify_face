...
export const TokenAuthPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Store token first so it's available for API calls
            setDeviceToken(token.trim());

            // Get device info using the token via /device/me endpoint
            const response: any = await deviceApi.getMe();
            ...
            setDeviceInfo({
                ...
                companyName: deviceData.company_id, // API doesn't return company name
            ...
            setDeviceToken(''); // Clear invalid token
            setError(
                err.message ||
