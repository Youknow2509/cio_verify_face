...
// AttendanceRecordsNoShiftResponse represents a list of attendance records without shift
type AttendanceRecordsNoShiftResponse struct {
	Records      []AttendanceRecordNoShiftResponse `json:"records"`
	TotalRecords int                               `json:"total_records"`
	YearMonth    string                            `json:"year_month,omitempty" example:"2024-01"`
}
