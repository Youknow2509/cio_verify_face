...
import (
	...
	domainCache "github.com/youknow2509/cio_verify_face/server/service_analytic/internal/domain/cache"
)
 ...
 */
func NewRedisDistributedCache(config *config.RedisConfig) (domainCache.IDistributedCache, error) {
