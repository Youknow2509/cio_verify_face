...
const options = {
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description:
                'API for managing companies, users, employees and face data',
            contact: {
                name: 'API Support',
                email: 'support@example.com',
            },
        },
        // Use relative server so Swagger UI calls the same origin (avoids localhost vs 127.0.0.1 issues)
        servers: [
            {
                url: '/',
                ...
                User: {
                    ...
                    properties: {
                        ...
                        role: {
                            ...
                            enum: [0, 1, 2],
                            description:
                                '0: SYSTEM_ADMIN, 1: COMPANY_ADMIN, 2: EMPLOYEE',
                        },
                        status: {
                            type: 'integer',
                            enum: [0, 1, 2],
