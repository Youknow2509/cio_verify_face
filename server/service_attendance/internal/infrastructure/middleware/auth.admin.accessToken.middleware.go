...
import (
	...
	utilsContext "github.com/youknow2509/cio_verify_face/server/service_attendance/internal/shared/utils/context"
	utilsCrypto "github.com/youknow2509/cio_verify_face/server/service_attendance/internal/shared/utils/crypto"
)

// Define the AuthAdminAccessTokenJwtMiddleware struct
type AuthAdminAccessTokenJwtMiddleware struct{}

/**
 * Apply method to process the JWT access token.
 */
func (m *AuthAdminAccessTokenJwtMiddleware) Apply() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if tokenObj.Role > domainModel.RoleManager {
